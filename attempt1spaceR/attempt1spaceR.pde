...
//updates the player 2's score and position
 ...
 alien6b.update();alien7b.update();alien8b.update();alien9b.update();alien10b.update();
  ...
  if(restartPressed == true){
    ...
    score =0;
    score2=0;
    alien1 = new Enemy(100,100);alien2 = new Enemy(250,100);alien3 = new Enemy(400,100);alien4 = new Enemy(550,100);alien5 = new Enemy(700,100);
    alien6 = new Enemy(100,300);alien7 = new Enemy(250,300);alien8 = new Enemy(400,300);alien9 = new Enemy(550,300);alien10 = new Enemy(700,300);
    alien1b = new Enemy2(1150,100);alien2b = new Enemy2(1300,100);alien3b = new Enemy2(1450,100);alien4b = new Enemy2(1600,100);alien5b = new Enemy2(1750,100);
    alien6b = new Enemy2(1150,300);alien7b = new Enemy2(1300,300);alien8b = new Enemy2(1450,300);alien9b = new Enemy2(1600,300);alien10b = new Enemy2(1750,300);
...
void drawText(){
 ...
 //adds a pop up that displays that player 1 won
  if(score == 1000 && score2 != 1000){
    ...
    textSize(100);
    fill(0);
    image(p1Wins,width/4,height/6.5,1000,600);
  ...
  if(score2 == 1000 && score != 1000){
    ...
    textSize(100);
    fill(0);
    image(p2Wins,width/4,height/6.5,1000,600);
